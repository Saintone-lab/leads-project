...
if (Auth::check()) {
    ...
    try {
        ...
        $query = "SELECT u.*, s.image, s.brand, s.pn, s.price, s.detail, CONCAT(u.stock, ' - ', u.warehouse_stock ) AS stok FROM unit u
        RIGHT JOIN serial_product s on u.id = s.id_product";
