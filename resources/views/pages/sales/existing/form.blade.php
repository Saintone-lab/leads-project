<form action="{{ @$existing ? route('existing.update', @$existing->id) : route('existing.store') }}" method="post"
    ...
    <div class="modal animate__animated animate__fadeIn"
        id="{{ @$existing ? 'updateExisting' . strval(@$existing->id) : 'createExisting' }}" tabindex="-1" style="display: none;"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="exampleModalLabel5">{{ @$existing ? 'Update Data' : 'Create New' }} Existing
                    </h4>
                            ...
                            <div class="form-floating form-floating-outline">
                                <select class="form-select" id="selectSource" aria-label="Default select example"
                                    ...
                                    <option value="LinkedIn"
                                        {{ old('source', @$existing->source) == 'LinkedIn' ? 'selected' : '' }}>LinkedIn
                                    </option>
                        ...
                        <div class="col mb-2">
                            <div class="form-floating form-floating-outline">
                                <select class="form-select" id="selectMobile" aria-label="Default select example"
                                    ...
                                    <option value="WA" {{ old('mobile', @$existing->mobile) == 'WA' ? 'selected' : '' }}>
                                        WhatsApp</option>
                                    <option value="Phone Office"
                                        {{ old('mobile', @$existing->mobile) == 'Phone Office' ? 'selected' : '' }}>Phone
                                        Office</option>
                                </select>
