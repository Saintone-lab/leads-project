                    ...
                    <div class="card h-100">
                        <div class="card-body text-nowrap">
                            ...
                            <h4 class="card-title mb-1">
                                Monthly Prospect Achievement 🎉
                            </h4>

                            <p class="pb-0 text-muted">
                                {{ now()->format('F Y') }}
                            </p>
                            ...
                            <p class="mb-2">
                                {{ $progress }}% achieved 
                                ({{ $remaining > 0 ? $remaining . ' lagi' : 'Target tercapai 🎯' }})
                            </p>
                        ...
                        <div class="card h-100">
                            <div class="card-body">
                                ...
                                <div class="card-info mt-4 pt-1">
                                    ...
                                    <div class="badge bg-label-secondary rounded-pill">Prospect Masuk </div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="card-info mt-4 pt-1">
                                <h4 class="mb-2">
                                    {{ $provided }}
                                        <small class="text-muted fs-tiny">/
                                             {{ $prospect > 0 ? round(($provided/$prospect)*100,1) : 0 }}%
                                        </small>
                                </h4>
                                <div class="badge bg-label-secondary rounded-pill">Provided Leads</div>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="card-info mt-4 pt-1">
                                <h4 class="mb-2">
                                    {{ $quotation }}
                                    <small class="text-muted fs-tiny">/
                                        {{ $prospect > 0 ? round(($quotation/$prospect)*100,1) : 0 }}%
                                    </small>
                                </h4>
                                <div class="badge bg-label-secondary rounded-pill">Quotation</div>
                            </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="card-info mt-4 pt-1">
                                <h4 class="mb-2">
                                    ...
                                    <small class="text-muted fs-tiny">
                                        {{ $prospect > 0 ? round(($loss/$prospect)*100,1) : 0 }}%
                                    </small>
                                </h4>
