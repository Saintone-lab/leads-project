            ...
            <table class="table table-bordered m-0" style="width: 100%">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td colspan="2" class="text-end"> {{ number_format($quote->subtotal, 0, '', '.') }}</td>
                    </tr>
                    @if ($quote->diskon != 0)
                        <tr>
                            <td colspan="3"></td>
                            <td" class="text-end"> Discount :</td>
                            <td colspan="2 class="text-end"> {{ number_format($quote->diskon, 0, '', '.') }}</td>
                        </tr>
                        <tr>
                            <td colspan="3"></td>
                    ...
                    @if ($quote->tax != 0)
                        <tr>
                            ...
                            <td colspan="2" class="text-end">{{ number_format($tax, 0, '', '.') }}</td>
                        </tr>
                    @endif
                    @if ($quote->shipping != 0)
                        <tr>
