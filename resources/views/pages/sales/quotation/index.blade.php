                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="d-flex justify-content-between align-items-start card-widget-1 border-end pb-3 pb-sm-0">
                            <div>
                                ...
                                <p class="mb-0"><span class="badge rounded-pill bg-label-success">{{$quotation->whereIn('status', ['20', '30','40','60','80'])->count()}}</span></p>
                            </div>
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="d-flex justify-content-between align-items-start card-widget-2 border-end pb-3 pb-sm-0">
                            <div>
                                ...
                                <p class="mb-0"><span class="badge rounded-pill bg-label-success">{{$quotation->where('status', '80')->count()}}</span></p>
                            </div>
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="d-flex justify-content-between align-items-start border-end pb-3 pb-sm-0 card-widget-3">
                            <div>
                                ...
                                <p class="mb-0"><span class="badge rounded-pill bg-label-success">{{$quotation->where('status', '100')->count()}}</span></p>
                            </div>
                            <div class="avatar me-sm-4">
                                <span class="avatar-initial rounded bg-label-secondary">
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="d-flex justify-content-between align-items-start">
                            <div>
                                ...
                                <p class="mb-0"><span class="badge rounded-pill bg-label-danger">{{$quotation->where('status', '0')->count()}}</span></p>
                            </div>
                            <div class="avatar">
                                <span class="avatar-initial rounded bg-label-secondary">
