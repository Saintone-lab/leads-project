                    ...
                    <div class="col-md-3">
                        <div class="form-floating form-floating-outline mb-4">
                            <select class="form-select" id="Type" aria-label="Default select example" name="type">
                                <option>---Type---</option>
                                <option value="Sparepart" {{ @$quotation->quote_for == 'Sparepart' ? 'selected' : '' }}>Sparepart
                                </option>
                                <option value="Unit" {{ @$quotation->quote_for == 'Unit' ? 'selected' : '' }}>Unit
                                </option>
                                <option value="Rental" {{ @$quotation->quote_for == 'Rental' ? 'selected' : '' }}>Rental
                                </option>
                                <option value="Service" {{ @$quotation->quote_for == 'Service' ? 'selected' : '' }}>Service
                                </option>
                            </select>
