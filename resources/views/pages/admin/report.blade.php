...
@section('content')
    <div class="d-flex justify-content-between flex-xl-row flex-md-column flex-sm-row flex-column">
        <div class="title">
            ...
            @endphp
            <h2 class="flex-wrap fw-semibold">OVERVIEW SEMESTER {{ $report->semester }} | {{ $report->year }}
                ({{ $fullPercent }}%)</h2>
        </div>
        <div class="text-end">
            <div class="btn-group">
            ...
            <div class="card h-100">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start flex-wrap gap-2">
                        ...
                        <div>
                              <h6 class="mb-1 fw-semibold">Purchase Order</h6>
                              <small class="text-muted text-end">{{ $poCount }}</small>
                        </div>
                    </div>
                    <div class="card-info mt-4 pt-1">
                        <h4 class="card-title mb-1 d-flex gap-2 flex-wrap fw-bold">Rp {{ number_format($poTotal, 0, ',', '.') }}</h4>
        ...
        <div class="col-6 col-md-3">
            <div class="card h-100">
                <div class="card-body">
                    ...
                    <div class="card-info mt-4 pt-1">
                        <h4 class="card-title mb-1 d-flex gap-2 flex-wrap fw-bold">Rp {{ number_format($quoteOnTotal, 0, ',', '.') }}</h4>
        ...
        <div class="col-6 col-md-3">
            <div class="card h-100">
                <div class="card-body">
                    ...
                    <div class="card-info mt-4 pt-1">
                        <h4 class="card-title mb-1 d-flex gap-2 flex-wrap fw-bold">Rp {{ number_format($lossTotal, 0, ',', '.') }}</h4>
        ...
        <div class="col-6 col-md-3">
            <div class="card h-100">
                <div class="card-body">
                    ...
                    <div class="card-info mt-4 pt-1">
                        <h4 class="card-title mb-1 d-flex gap-2 flex-wrap fw-bold">Rp {{ number_format($quoteTotal, 0, ',', '.') }}</h4>
