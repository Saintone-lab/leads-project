...
@section('content')
    ...
    {{-- Modal: Tambah Tools --}}
    <form action="{{ route('tool-assignment.store', $technician->id) }}" method="post" enctype="multipart/form-data">
        @csrf
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            <label class="form-label">Jenis Tools</label>
                            <select class="form-select" name="id_tools_master" required>
                                <option value="" disabled selected>-- Pilih dari Master Tools --</option>
                                @foreach ($toolMasters as $master)
                                    <option value="{{ $master->id }}">{{ $master->nama_tools }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <small class="text-muted">Bisa dimundurkan kalau tools ini sudah lama dipegang teknisi.</small>
                        </div>
                        <div class="mb-3">
