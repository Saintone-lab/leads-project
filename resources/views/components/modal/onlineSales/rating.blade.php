<form action="{{@$rating ? route('update.salon',@$rating->id) : route('store.salon')}}" method="post" enctype="multipart/form-data">
    @csrf
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-8 mb-3">
                                    <input class="form-control form-control-lg" type="text" placeholder="Target"
                                        ...
                                        maxlength="4" value="{{ @$rating->kojisha ? str_replace('.', ',', $rating->kojisha) : '0' }}">
                                </div>
                                    ...
                                    <div class="card text-center bg-label-secondary">
                                        <div class="card-body">
                                            ...
                                            <input type="text" name="average" id="averageRating"
                                                value="{{ @$rating->average ? str_replace('.', ',', $rating->average) : '0' }}" hidden>
                                            <h5>Average</h5>
                                            <p id="averageRatingText">{{ @$rating->average ? str_replace('.', ',', $rating->average) : '0' }}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
