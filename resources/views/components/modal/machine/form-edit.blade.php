<form action="{{route('machine.update', $machine->id)}}" method="patch"
    
        enctype="multipart/form-data">
        @csrf
        <div class="modal animate__animated animate__fadeIn"
            id="createMachine{{$machine->id}}" tabindex="-1" style="display: none;"
            aria-hidden="true">
                            ...
                            <div class="col-3 mb-2">
                                <div class="form-floating form-floating-outline">
                                    <input type="phone" id="runningAnimation" class="form-control" name="running"
                                        placeholder="Example : 100"
                                        value="{{ old('running', @$machine->running ?? '') }}">
