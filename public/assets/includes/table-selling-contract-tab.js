$(function () {
    var $table = $('.datatable-selling-contract-tab');
            ...
            { targets: 1, searchable: true, visible: false },
            {
                ...
                render: function (data, type, full) {
                    if (type === 'display') {
                        ...
                        return '<a class="text-dark" href="' + url + '">' + data + '</a>';
                    }
                    return data;
                },
            },
        ...
        responsive: {
            details: {
                display: $.fn.dataTable.Responsive.display.modal({
                    header: function (row) { return 'Details of ' + row.data()['company']; },
                }),
                type: 'column',
    ...
    $('#filter-year-selling, #filter-tax-selling').on('change', function () {
        dt.ajax.url(buildUrl()).load();
    });

    $('button[data-bs-target="#tab-selling"]').on('shown.bs.tab', function () {
