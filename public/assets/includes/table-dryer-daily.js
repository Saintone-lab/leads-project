$(function () {
    var ddt_table_ryer = $(".datatable-dryer");
    var Url = "/db/monitoring/dryer/";
    ...
    if (ddt_table_ryer.length) {
        $('[data-toggle="tooltip"]').tooltip();
        var ddt_ryer = ddt_table_ryer.DataTable({
            ajax: {
                type: "GET",
                url: Url + id + "/" + month,
                headers: {
    ...
    ddt_table_ryer.on("draw", function () {
        $('[data-toggle="tooltip"]').tooltip();
    });
});
