$(function () {
    var dt_table_sales_completed_search_retur = $(
        ".datatable-sales-completed-retur"
    );
    var Url = "/db/pending/sales-retur";

    if (dt_table_sales_completed_search_retur.length) {
        ...
        var dt_filter = dt_table_sales_completed_search_retur.DataTable({
            ajax: {
                type: "GET",
                url: Url,
                headers: {
    ...
    dt_table_sales_completed_search_retur.on("draw", function () {
        $('[data-toggle="tooltip"]').tooltip();
    });
});
