$(function () {
    var dt_table_sales_list_search = $(".datatable-sales-list-search");
    var Url = "/db/pending/sales-list";

    if (dt_table_sales_list_search.length) {
        $('[data-toggle="tooltip"]').tooltip();
        // Setup - add a text input to each footer cell
        $(".datatable-sales-list-search thead tr")
            .clone(true)
            .appendTo(".datatable-sales-list-search thead");
        $(".datatable-sales-list-search thead tr:eq(1) th").each(function (i) {
            var title = $(this).text();
            $(this).html(
        ...
        var dt_filter = dt_table_sales_list_search.DataTable({
            ajax: {
                type: "GET",
                url: Url,
                headers: {
    ...
    dt_table_sales_list_search.on("draw", function () {
        $('[data-toggle="tooltip"]').tooltip();
    });
});
