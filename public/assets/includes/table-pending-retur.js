$(function () {
    var dt_table_pending_retur = $(".datatable-pending-po-retur");
    var Url = "db/pending/po/retur";

    if (dt_table_pending_retur.length) {
        $('[data-toggle="tooltip"]').tooltip();
        var dt_pending = dt_table_pending_retur.DataTable({
            ajax: {
                type: "GET",
                url: Url,
                headers: {
    ...
    dt_table_pending_retur.on("draw", function () {
        $('[data-toggle="tooltip"]').tooltip();
    });
});
