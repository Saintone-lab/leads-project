$(function () {
    var dt_table_reseller_admin = $(".datatable-reseller-admin");
    var Url = "db/client/reseller/admin";

    if (dt_table_reseller_admin.length) {
        var dt_reseller = dt_table_reseller_admin.DataTable({
            // ajax: assetsPath + "api/reseller/connection.php",
            ajax: {
                type: "GET",
                url: Url,
                headers: {
        ...
        $("div.head-label").html('<h5 class="card-title mb-0">Table Reseller</h5>');
    }
});
