$(function () {
    var dt_table_recap_month_week = $(".datatable-recap-month-week");
    var Url = "/db/bulan/";

    // console.log("ID:", id); // Output: ID: 2

    if (dt_table_recap_month_week.length) {
        $('[data-toggle="tooltip"]').tooltip();
        var dt_product = dt_table_recap_month_week.DataTable({
            ajax: {
                type: "GET",
                url: Url,
                headers: {
            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    render: function (data, type, full, row) {
                        var $monthNum = full["monthNum"];
                        var $year = full["year"];
                        var detailRoute = route("service-manager.recap-week", [
                            $monthNum,
                            $year,
                        ]);
                        return (
    ...
    dt_table_recap_month_week.on("draw", function () {
        $('[data-toggle="tooltip"]').tooltip();
    });
});
