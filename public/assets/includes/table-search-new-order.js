$(function () {
    var dt_table_new_order_search = $(".datatable-new-order-search");
    var Url = "db/pending/new-order";

    if (dt_table_new_order_search.length) {
        $('[data-toggle="tooltip"]').tooltip();
        // Setup - add a text input to each footer cell
        $(".datatable-new-order-search thead tr")
            .clone(true)
            .appendTo(".datatable-new-order-search thead");
        $(".datatable-new-order-search thead tr:eq(1) th").each(function (i) {
            var title = $(this).text();
            $(this).html(
        ...
        var dt_filter = dt_table_new_order_search.DataTable({
            ajax: {
                type: "GET",
                url: Url,
                headers: {
    ...
    dt_table_new_order_search.on("draw", function () {
        $('[data-toggle="tooltip"]').tooltip();
    });
});
