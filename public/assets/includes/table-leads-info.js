$(function () {
    var dt_table_leads_info = $(".datatable-leads-info");
    var Url = "db/leads";

    if (dt_table_leads_info.length) {
        $('[data-toggle="tooltip"]').tooltip();
        var dt_leads = dt_table_leads_info.DataTable({
    ...
    dt_table_leads_info.on("draw", function () {
        $('[data-toggle="tooltip"]').tooltip();
    });
});
