$(function () {
    var dt_table_dryer_client = $(".datatable-dryer-client");
    var Url = "/db/dryer/fp/";

    // console.log("ID:", id); // Output: ID: 2

    if (dt_table_dryer_client.length) {
        $('[data-toggle="tooltip"]').tooltip();
        var dt_product = dt_table_dryer_client.DataTable({
            ajax: {
                type: "GET",
                url: Url,
                headers: {
    ...
    dt_table_dryer_client.on("draw", function () {
        $('[data-toggle="tooltip"]').tooltip();
    });
});
