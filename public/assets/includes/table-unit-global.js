$(function () {
    var dt_table_product_unit_global = $(".datatable-product-unit-global");
    var Url = "/db/unit/global";

    if (dt_table_product_unit_global.length) {
        $('[data-toggle="tooltip"]').tooltip();
        var dt_product = dt_table_product_unit_global.DataTable({
            ajax: {
                type: "GET",
                url: Url,
                headers: {
    ...
    dt_table_product_unit_global.on("draw", function () {
        $('[data-toggle="tooltip"]').tooltip();
    });
});
