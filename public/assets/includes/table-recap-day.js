$(function () {
    var dt_table_recap_day = $(".datatable-recap-day");
    var Url = "/db/days/";
    ...
    if (dt_table_recap_day.length) {
        $('[data-toggle="tooltip"]').tooltip();
        var dt_product = dt_table_recap_day.DataTable({
            ajax: {
                type: "GET",
                url: Url + month + '/' + year,
                headers: {
                ...
                },
                {
                    ...
                    render: function (data, type, full, row) {
                        if (type === "display") {
                            ...
                            var $date = full["date"];
                            var detailRoute = route("service-manager.recap-monitoring", [$date]);
                            return (
    ...
    dt_table_recap_day.on("draw", function () {
        $('[data-toggle="tooltip"]').tooltip();
    });
});
