$(function () {
    var dt_table_monitoring_reports = $(".datatable-monitoring-reports");
    var Url = "/db/monitoring/hold/";
    ...
    if (dt_table_monitoring_reports.length) {
        $('[data-toggle="tooltip"]').tooltip();
        var dt_product = dt_table_monitoring_reports.DataTable({
            ajax: {
                type: "GET",
                url: Url + year + '/' + month,
                headers: {
    ...
    dt_table_monitoring_reports.on("draw", function () {
        $('[data-toggle="tooltip"]').tooltip();
    });
});
