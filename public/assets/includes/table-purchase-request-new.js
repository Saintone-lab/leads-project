$(function () {
    var dt_table_purchase_request_new = $(".datatable-purchase-request-new");
    var Url = "db/purchase-request/new";

    if (dt_table_purchase_request_new.length) {
        $('[data-toggle="tooltip"]').tooltip();
        // Setup - add a text input to each footer cell
        $(".datatable-purchase-request-new thead tr")
            .clone(true)
            .appendTo(".datatable-purchase-request-new thead");
        $(".datatable-purchase-request-new thead tr:eq(1) th").each(function (i) {
            var title = $(this).text();
            $(this).html(
        ...
        var dt_filter = dt_table_purchase_request_new.DataTable({
            ajax: {
                type: "GET",
                url: Url,
                headers: {
    ...
    dt_table_purchase_request_new.on("draw", function () {
        $('[data-toggle="tooltip"]').tooltip();
    });
});
